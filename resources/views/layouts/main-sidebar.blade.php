		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='store') }}">
                            <span class="side-menu__label">Store</span></a>
					</li>
                    <li class="slide">
                        <a class="side-menu__item" href="{{ url('/' . $page='species') }}">
                            <span class="side-menu__label">{{__('trans.species')}}</span></a>
                    </li>
<!--
                    <li class="slide">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" href="{{ url('/logout') }}">
                            <span class="side-menu__label">{{__('trans.logout')}}</span></a>
                    </li>
                </ul>
			</div>
		</aside>
